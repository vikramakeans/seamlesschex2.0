...
Route::group(['prefix' => 'api'], function()
{
	...
	// Register using step1 and step2
	Route::post('register/basic', 'UserStepController@registerBasic');
	Route::get('api/authenticate/step', 'AuthenticateController@getAuthenticatedStepUser');
	Route::get('authenticate/user/step/{sc_token}', 'UserStepController@getUserByToken');
	...
	Route::get('authenticate/editcheck/{check_token}', 'CheckController@editCheck');
	...
	Route::post('authenticate/checkduplicates', 'CheckController@getCheckNumberDuplicates');
	...
	Route::post('authenticate/enter/update/check/{check_token}', 'CheckController@updateCheck');
	Route::post('authenticate/check/deletecheck', 'CheckController@deleteCheck');
	Route::get('authenticate/check/printcheck/{check_token}', 'CheckController@printCheck');
	Route::post('authenticate/check/printcheckonpaper', 'CheckController@printCheckOnPaper');
	Route::post('authenticate/check/printcheckonplainpaper', 'CheckController@printCheckOnPlainPaper');
