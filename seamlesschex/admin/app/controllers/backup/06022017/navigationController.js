(function() {
	...
	function NavigationController($rootScope, $scope, $state, $templateCache, $timeout) {
		...
		$scope.clearCache = function() { 
		 ...
		 //console.log($rootScope.currentUser.permissions);
		  this.menu = [
			...
			//{ name : 'Add a Business', iconClasses: 'fa fa-building-o', sref: 'company-sub',  subMenu: false,
					//menu : [{}]
			//},
		...
		this.adminmenu =  [
			...
			{ name : 'Seamlesschex Admin', iconClasses: 'fa  fa-user-md', permissionValue: $rootScope.currentUser.permissions.SCXADMIN, sref: 'seamlesschex-admins', subMenu: false,
						menu : [{}] 
			},
			{ name : 'Merchants', iconClasses: 'fa  fa-user-md', permissionValue: $rootScope.currentUser.permissions.MERCHANTS, sref: 'companies', subMenu: false,
					menu : [{}] 
			},
			{ name : 'Multiple Subscriptions', iconClasses: 'fa  fa-user-md', permissionValue: $rootScope.currentUser.permissions.MULTIPLESUBSCRIPTIONS, sref: 'subscriptions', subMenu: false,
					menu : [{}]
			},
			//{ name : 'Add a Business', iconClasses: 'fa fa-building-o', permissionValue: $rootScope.currentUser.permissions.ADDMERCHANTS, sref: 'company-sub',  subMenu: false,
					//menu : [{}]
			//},
			{ name : 'User Permissions', iconClasses: 'fa fa-users', permissionValue: $rootScope.currentUser.permissions.USERPERMISSIONS, sref: 'company-users', subMenu: false,
					menu : [{}]
			},
			...
			{ name : 'Invoice', iconClasses: 'fa fa-file-text-o', permissionValue: $rootScope.currentUser.permissions.INVOICE, sref: '#/', subMenu: false,
					menu : [{}]
			},
			{ name : 'Batch', permissionValue: $rootScope.currentUser.permissions.BATCH, iconClasses: 'fa fa-exchange', subMenu: true,
					menu : [
							{
								name: 'Import checks',
								iconClasses: '',
			...
			{ name : 'Settings', iconClasses: 'fa fa-gears', permissionValue: $rootScope.currentUser.permissions.SETTINGS, subMenu: true,
					menu : [
							{
								name: 'Fees settings',
								iconClasses: '',
			...
			{ name : 'Email Templates', iconClasses: 'fa fa-gears', permissionValue: $rootScope.currentUser.permissions.EMAILTEMPLATES, sref: 'email-template', subMenu: false,
					menu : [{}]
			},
			{ name : 'Plans', iconClasses: 'fa fa-gears',  permissionValue: $rootScope.currentUser.permissions.PLANS, sref: 'plan-list', subMenu: false,
					menu : [{}]
			},
			{ name : 'Acitivity Logs', iconClasses: 'fa fa-history', permissionValue: $rootScope.currentUser.permissions.ACTIVITYLOGS,  sref: 'activity-logs', subMenu: false,
					menu : [{}]
			},
			{ name : 'Profile', iconClasses: 'fa fa-history',  permissionValue: $rootScope.currentUser.permissions.PROFILE, sref: 'profile-details', subMenu: false, 
					menu : [{}]
			}
		];
		...
		{ name : 'Account', iconClasses: 'fa fa-exchange', permissionValue: $rootScope.currentUser.permissions.ACCOUNT, sref: 'merchant-account', subMenu: false,
				menu : [{}]
		},
		{ name : 'Add a Business', iconClasses: 'fa fa-gears', permissionValue: $rootScope.currentUser.permissions.COMPANY, subMenu: true,
				menu : [
						{
							name: 'Companies',
							iconClasses: '',
		...
		{ name : 'Add a Business', iconClasses: 'fa fa-gears', permissionValue: $rootScope.currentUser.permissions.COMPANY,
				menu : [
						{
							name: 'Add a Business',
							iconClasses: '',
