(function() {
	...
	function MultiStepFormController($scope, $location, $auth, $state, $http, $rootScope, API_URL, $payments, $stateParams, $timeout, $filter) {
		...
		if($scope.sc_token && $scope.sc_token != null && $scope.action == 'editCompanyAdmin'){
			...
			$scope.batchSettings = function() {
				...
				[{'monday_time':moment($scope.company.time.monday).format('H:m A'), 'monday_timezone':$scope.company.timezone.monday, 'tuesday_time':moment($scope.company.time.tuesday).format('H:m A'), 'tuesday_timezone':$scope.company.timezone.tuesday, 'wednesday_time':moment($scope.company.time.wednesday).format('H:m A'), 'wednesday_timezone':$scope.company.timezone.wednesday, 'thursday_time':moment($scope.company.time.thursday).format('H:m A'), 'thursday_timezone':$scope.company.timezone.thursday, 'friday_time':moment($scope.company.time.friday).format('H:m A'), 'friday_timezone':$scope.company.timezone.friday, 'saturday_time':moment($scope.company.time.saturday).format('H:m A'), 'saturday_timezone':$scope.company.timezone.saturday, 'sunday_time':moment($scope.company.time.sunday).format('H:m A'), 'sunday_timezone':$scope.company.timezone.sunday}]
				}];
