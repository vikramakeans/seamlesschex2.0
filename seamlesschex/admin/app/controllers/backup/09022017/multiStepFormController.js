(function() {
	...
	function MultiStepFormController($scope, $location, $auth, $state, $http, $rootScope, API_URL, $payments, $stateParams, $timeout, $filter, $mdDialog) {
		...
		if(($rootScope.authenticated == true && $rootScope.authSuAdmin == true && $scope.action == 'editCompanyAdmin') || ($rootScope.authenticated == true &&  $scope.authScxAdmin == true && $scope.action == 'editCompanyAdmin')){
