(function() {
	...
	function NavigationController($rootScope, $scope, $state, $templateCache, $timeout) {
		...
		$scope.clearCache = function() { 
		 ...
		 //console.log($rootScope.currentUser.permissions);
		  this.menu = [
			...
			{ name : 'Companies', iconClasses: 'fa  fa-user-md', sref: 'companies', subMenu: false,
					menu : [{}] 
			},
			{ name : 'Multiple Subscriptions', iconClasses: 'fa  fa-user-md', sref: 'subscriptions', subMenu: false,
					menu : [{}]
			},
			{ name : 'Add Companies', iconClasses: 'fa fa-building-o', sref: 'company-sub',  subMenu: false,
					menu : [{}]
			},
			{ name : 'Company User', iconClasses: 'fa fa-users', sref: 'company-users', subMenu: false,
					menu : [{}]
			},
		...
		{ name : 'Seamlesschex Admin', iconClasses: 'fa  fa-user-md', permissionValue:'', sref: 'seamlesschex-admins', subMenu: false,
			...
			{ name : 'Company User', iconClasses: 'fa fa-users', permissionValue:'', sref: 'company-users', subMenu: false,
					menu : [{}]
			},
