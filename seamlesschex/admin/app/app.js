(function() {
	...
	angular
		.module('authApp', ['ui.router', 'satellizer', 'phonenumberModule','ngPayments','chieffancypants.loadingBar', 'ngAnimate', 'ui.bootstrap', 'angularjs-datetime-picker', 'ui.select2', 'dnTimepicker','ngMaterial', 'textAngular', 'angularSlideables', 'angular-clipboard','colorpicker.module', 'export.csv', 'angularFileUpload', 'ngFileUpload', 'ui.timepicker', 'ngLoadingSpinner', 'ngFlash', 'signature', 'LocalStorageModule', 'ui.mask' ])
		...
		.config(function($stateProvider,  $urlRouterProvider, $authProvider, $httpProvider, $provide, cfpLoadingBarProvider, API_URL) {
			...
			$stateProvider
				...
				.state('upgrade-account', {
				  url: '/upgrade-account/:sc_token',
				  params: {
						action: 'stepUserDetails',
					},
				  templateUrl: '../admin/views/upgrade-account.html',
				  controller: 'RegisterController as register'
				})
				...
				.state('invite-muser', {
					needLogin: false,
					//companyUser: true,
					url: '/invite-muser/:confirm_token',
					templateUrl: '../admin/views/invite-muser.html',
					controller: 'PasswordController as setpass'
				})
				.state('forget-password', {
					needLogin: false,
					//companyUser: true,
					url: '/forget-password',
					templateUrl: '../admin/views/forget-password.html',
					controller: 'PasswordController as setpass'
				})
				.state('set-password', {
					needLogin: false,
					...
					templateUrl: '../admin/views/set-password.html',
					controller: 'PasswordController as setpass'
				})
				...
				.state('invoice-view', {
					...
					templateUrl: '../admin/views/receipt.html',
					controller: 'InvoiceController as invoice'
				...
				.state('search-checks', {
					...
					params: {
						sc_token: null,
						check_company_admin: null,
						check_company_user: null,
						check_month: null,
						check_from_date: null,
						check_to_date: null,
						action: 'viewChecks'
					},
					templateUrl: '../admin/views/search-checks.html',
					controller: 'CheckController as check'
					
				})
				.state('search-recurrent-checks', {
					needLogin: true,
					url: '/search-recurrent-checks',
					params: {
						sc_token: null,
						check_company_admin: null,
						check_company_user: null,
						...
						check_from_date: null,
						check_to_date: null,
						action: 'viewRecurrentChecks'
					},
					templateUrl: '../admin/views/search-recurrent-checks.html',
					controller: 'CheckController as check'
					
				})
				.state('edit-check', {
					needLogin: true,
					url: '/edit-check/:check_token',
					params: {
						action: 'editCheck'
					},
					templateUrl: '../admin/views/edit-checks.html',
					controller: 'CheckController as check'
				...
				.state('merchant-account', {
					...
					params: {
						action: 'merchantAccount',
						
					},
					templateUrl: '../admin/views/merchant-account.html',
				    //controller: 'CompanyUserController as companyadmin'
				...
				.state('send-check', {
					...
					templateUrl: '../admin/views/send-check.html',
					//controller: 'CompanyAdminController as companyadmin'
				...
				.state('want-to-print', {
					...
					templateUrl: '../admin/views/want-to-print.html',
					//controller: 'CompanyAdminController as companyadmin'
					
				})
				.state('print-send-check', {
					needLogin: false,
					url: '/print-send-check',
					
					templateUrl: '../admin/views/print-send-check.html',
					//controller: 'CompanyAdminController as companyadmin'
					
				})
				
				.state('processed-check', {
					needLogin: false,
					url: '/processed-check',
					
					templateUrl: '../admin/views/processed-check.html',
					//controller: 'CompanyAdminController as companyadmin'
		...
		.run(function($rootScope, $state, $timeout, $document, localStorageService) {
