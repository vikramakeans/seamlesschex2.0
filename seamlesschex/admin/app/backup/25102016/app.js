(function() {
	...
	angular
		.module('authApp', ['ui.router', 'satellizer', 'phonenumberModule','ngPayments','chieffancypants.loadingBar', 'ngAnimate', 'ui.bootstrap', 'angularjs-datetime-picker','scania.angular.select2', 'dnTimepicker','ngMaterial', 'textAngular', 'angularSlideables', 'jqtimepickerModule', 'angular-clipboard','colorpicker.module'])
